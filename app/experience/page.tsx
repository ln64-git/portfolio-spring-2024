				...
				>
					...
					<div className="space-y-2 sm:space-y-3 h-full flex flex-col">
						...
						<div className="flex justify-center flex-shrink-0">
							<button 
								type="button"
								className="relative group w-full max-w-32 sm:max-w-40 md:max-w-64 lg:max-w-80 xl:max-w-96 h-16 sm:h-20 md:h-32 lg:h-40 xl:h-48 cursor-pointer border-none bg-transparent p-0"
							...
							>
								...
								<div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors duration-300 rounded-2xl flex items-center justify-center">
									<div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-white/20 backdrop-blur-sm rounded-full p-2 md:p-3">
									<svg className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
